    ...
    return (
        <View className="items-center justify-center mt-5">
            {avatarUrl ? (
                ...
                <View
                    style={avatarSize}
                    className="rounded-[5px] overflow-hidden max-w-full mb-5 bg-[#333] border border-[rgb(200,200,200)]"
                />
            )}
            <View>
                <TouchableOpacity
                ...
                >
                    {/*
          <Text className="text-white text-base font-semibold">{uploading ? t'Uploading ...' : 'Upload'}</Text>
                    */}
